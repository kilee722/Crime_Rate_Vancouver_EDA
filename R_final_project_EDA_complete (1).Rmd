...
```{r}
# TYPE BY MONTH FOR 2003
crime %>%
  filter( YEAR %in% '2003') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2004
crime %>%
  filter( YEAR %in% '2004') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2005
crime %>%
  filter( YEAR %in% '2005') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2006
crime %>%
  filter( YEAR %in% '2006') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2007
crime %>%
  filter( YEAR %in% '2007') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2008
crime %>%
  filter( YEAR %in% '2008') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2009
crime %>%
  filter( YEAR %in% '2009') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2010
crime %>%
  filter( YEAR %in% '2010') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2011
crime %>%
  filter( YEAR %in% '2011') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2012
crime %>%
  filter( YEAR %in% '2012') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2013
crime %>%
  filter( YEAR %in% '2013') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2014
crime %>%
  filter( YEAR %in% '2014') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2015
crime %>%
  filter( YEAR %in% '2015') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2016
crime %>%
  filter( YEAR %in% '2016') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')

# TYPE BY MONTH FOR 2017
crime %>%
  filter( YEAR %in% '2017') %>% ggplot(aes(x = MONTH, color = TYPE)) + geom_line(stat = 'count')
```
...
crime %>% filter(COMM %in% c("Safe_comm", "Unsafe_comm")) %>% ggplot(aes(x= CLASS,  group=COMM)) + 
...
## Is Vancouver getting safer? If so, what is the leading cause for it?
...
grid.arrange(
  crime %>% ggplot(aes(x = YEAR)) + geom_line(stat = 'count')+ ylim(0, 50000) + theme_classic(),
  crime %>% filter(!CLASS %in% "Theft") %>% ggplot(aes(x = YEAR)) + geom_line(stat = 'count')+ ylim(0, 50000) + theme_classic(),


crime %>% ggplot(aes(x = YEAR, color = CLASS, fill = CLASS)) + geom_line(stat = 'count') + ylim(0, 50000) +theme_classic(),

crime %>% filter(!CLASS %in% "Theft") %>% ggplot(aes(x = YEAR, color = CLASS, fill = CLASS)) + geom_line(stat = 'count') + ylim(0, 50000) +theme_classic()
...
* Each section has 3 types of maps including William's original map, heat map, and RgoogleMap

## Theft from Vehicle Map of Year 2003
```{r}
crime_tv_2003 <- crime_n %>% filter(YEAR %in% "2003") %>% filter(TYPE %in% "Theft from Vehicle")

crime_theft_2011 <- crime_n %>% filter(YEAR %in% "2011") %>% filter(TYPE %in% "Theft from Vehicle")

crime_theft_2016 <- crime_n %>% filter(YEAR %in% "2016") %>% filter(TYPE %in% "Theft from Vehicle")

# Read in the data
rawdata <- data.frame(as.numeric(crime_tv_2003$Longitude), as.numeric(crime_tv_2003$Latitude))
...
## Theft from Vehicle Map of Year 2011
```{r}
crime_tv_2011 <- crime_n %>% filter(YEAR %in% "2011") %>% filter(TYPE %in% "Theft from Vehicle")

# Read in the data
rawdata <- data.frame(as.numeric(crime_tv_2011$Longitude), as.numeric(crime_tv_2011$Latitude))
names(rawdata) <- c("lon", "lat")
data <- as.matrix(rawdata)
...
## Theft from Vehicle Map of Year 2016
```{r}
crime_tv_2016 <- crime_n %>% filter(YEAR %in% "2016") %>% filter(TYPE %in% "Theft from Vehicle")

# Read in the data
rawdata <- data.frame(as.numeric(crime_tv_2016$Longitude), as.numeric(crime_tv_2016$Latitude))
names(rawdata) <- c("lon", "lat")
data <- as.matrix(rawdata)
